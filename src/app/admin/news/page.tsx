...
export default async function AdminNewsPage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8">
      ...
      {/* Toolbar */}
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-white/50 backdrop-blur-md p-4 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {news.length === 0 && (
          <div className="col-span-full py-20 text-center bg-white/30 rounded-3xl border-2 border-dashed border-slate-200">
        ...
        {news.map((item: any) => (
          <div 
            key={item.id}
            className="group flex flex-col bg-white rounded-3xl border border-slate-200 overflow-hidden hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300"
          >
            {/* Image/Placeholder */}
